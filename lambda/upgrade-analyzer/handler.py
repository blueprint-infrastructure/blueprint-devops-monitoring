...
CHAIN_UPGRADE_CONTEXT = {
    "avalanche": (
        ...
        "  Script URL: https://raw.githubusercontent.com/blueprint-infrastructure/bpte/main/deploy/avalanche/avax-upgrade.sh "
        "  The script handles: pre-flight checks → backup → apt install → restart → health wait (600s) → verify. Auto-rollback on failure. "
        "  upgrade_steps should be EXACTLY: "
        "    1) wget -q <script_url> -O /opt/avax-upgrade.sh && chmod +x /opt/avax-upgrade.sh "
